...
import { Copy, Trash2, FileText, MessageSquare, Hash, Loader2 } from 'lucide-react'
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 backdrop-blur-sm">
        ...
        <Textarea
          ...
          className="min-h-[160px] resize-y border-0 bg-transparent px-4 py-4 text-white placeholder:text-zinc-600 focus-visible:ring-0 focus-visible:ring-offset-0"
        />
      </div>
