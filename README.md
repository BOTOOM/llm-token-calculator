...
- **Dark Mode UI**: Beautiful cosmic night theme optimized for developers

## Supported Providers

| Provider | Models |
|----------|--------|
| OpenAI | GPT-4.1, GPT-5, GPT-5.4, o1, o3, o4-mini |
| Anthropic | Claude 3.5, Claude 4, Claude 4.6 Opus |
| Google | Gemini 2.5, Gemini 3, Gemini 3.1 Flash/Pro |
| AWS Bedrock | Nova, Claude, Titan |
...
1. **Paste your prompt** in the input area
...
5. **Compare costs** in the interactive table
...
- [Live Demo](https://llm-token-calculator.vercel.app)
